...
$pdf->Cell(40,10,'COLEGIO DE KINESIOLOGOS DE LA PROVINCIA DE CORRIENTES');
$pdf->Ln(5);

$pdf->SetTextColor(0,0,0);
$pdf->SetFont('Arial','',9);
$pdf->Cell(40,10,'Dirección: Galeria Santa Fé, Santa Fé 941 (3400)');
$pdf->Ln(5);
$pdf->Cell(40,10,'Teléfono: (0379)-442-2145');
$pdf->Ln(5);
$pdf->Cell(40,10,'Obra Social: ('.$obra[0].') - '.$obra[1]);
$pdf->Ln(5);
$pdf->Cell(40,10,'Facturación correspondiente a: '.$periodo[1].' / '.$periodo[0]);
$pdf->Ln(5);
$pdf->Cell(40,10,'Número de Factura: '.$fila_f['id_factura']);
$pdf->Ln(20);
